...
class TestWebhookDeliveryLogResource(unittest.TestCase):
    """WebhookDeliveryLogResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDeliveryLogResource:
        """Test WebhookDeliveryLogResource
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDeliveryLogResource`
        """
        model = WebhookDeliveryLogResource()
        if include_optional:
    ...
    def testWebhookDeliveryLogResource(self):
        """Test WebhookDeliveryLogResource"""
