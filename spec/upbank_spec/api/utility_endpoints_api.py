...
from upbank_client.models import PingResponse
...
class UtilityEndpointsApi:
    ...
    async def util_ping_get(
        ...
        _param = self._util_ping_get_serialize(
    ...
    @validate_call
    async def util_ping_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def util_ping_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
