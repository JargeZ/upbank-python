...
class UpdateTransactionCategoryRequestData(BaseModel):
    """
    ...
    id: StrictStr = Field(description="The unique identifier of the category, as returned by the `/categories` endpoint. ")
