...
class WebhookEventResourceRelationshipsTransaction(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": WebhookEventResourceRelationshipsTransactionData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
