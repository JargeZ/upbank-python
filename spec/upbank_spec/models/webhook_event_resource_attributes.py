...
class WebhookEventResourceAttributes(BaseModel):
    """
    WebhookEventResourceAttributes
    """ # noqa: E501
    event_type: WebhookEventTypeEnum = Field(alias="eventType")
    created_at: datetime = Field(description="The date-time at which this event was generated. ", alias="createdAt")
    __properties: ClassVar[List[str]] = ["eventType", "createdAt"]
