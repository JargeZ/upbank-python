...
class WebhookResourceRelationships(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "logs": AccountResourceRelationshipsTransactions.from_dict(obj.get("logs")) if obj.get("logs") is not None else None
        })
        return _obj
