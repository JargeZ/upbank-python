...
class WebhookResource(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type of this resource: `webhooks`")
    id: StrictStr = Field(description="The unique identifier for this webhook. ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": WebhookResourceAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": WebhookResourceRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
