...
class AccountResourceRelationshipsTransactionsLinks(BaseModel):
    """
    AccountResourceRelationshipsTransactionsLinks
    """ # noqa: E501
    related: StrictStr = Field(description="The link to retrieve the related resource(s) in this relationship. ")
