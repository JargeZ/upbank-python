...
class AccountResource(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type of this resource: `accounts`")
    id: StrictStr = Field(description="The unique identifier for this account. ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": AccountResourceAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
