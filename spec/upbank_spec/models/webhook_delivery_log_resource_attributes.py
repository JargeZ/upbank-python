...
class WebhookDeliveryLogResourceAttributes(BaseModel):
    """
    WebhookDeliveryLogResourceAttributes
    """ # noqa: E501
    request: WebhookDeliveryLogResourceAttributesRequest
    response: Optional[WebhookDeliveryLogResourceAttributesResponse]
    delivery_status: WebhookDeliveryStatusEnum = Field(alias="deliveryStatus")
    created_at: datetime = Field(description="The date-time at which this log entry was created. ", alias="createdAt")
    __properties: ClassVar[List[str]] = ["request", "response", "deliveryStatus", "createdAt"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "request": WebhookDeliveryLogResourceAttributesRequest.from_dict(obj.get("request")) if obj.get("request") is not None else None,
            "response": WebhookDeliveryLogResourceAttributesResponse.from_dict(obj.get("response")) if obj.get("response") is not None else None,
