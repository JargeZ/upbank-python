...
class TransactionResourceRelationshipsAccount(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": TransactionResourceRelationshipsAccountData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
