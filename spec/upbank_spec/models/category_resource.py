...
class CategoryResource(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type of this resource: `categories`")
    id: StrictStr = Field(description="The unique identifier for this category. This is a human-readable but URL-safe value. ")
    attributes: CategoryResourceAttributes
    relationships: CategoryResourceRelationships
    links: Optional[AccountResourceLinks] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": CategoryResourceAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": CategoryResourceRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "links": AccountResourceLinks.from_dict(obj.get("links")) if obj.get("links") is not None else None
        })
        return _obj
