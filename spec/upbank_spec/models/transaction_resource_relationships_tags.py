...
class TransactionResourceRelationshipsTags(BaseModel):
    """
    TransactionResourceRelationshipsTags
    """ # noqa: E501
    data: List[TransactionResourceRelationshipsTagsDataInner]
    links: Optional[TransactionResourceRelationshipsTagsLinks] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [TransactionResourceRelationshipsTagsDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "links": TransactionResourceRelationshipsTagsLinks.from_dict(obj.get("links")) if obj.get("links") is not None else None
        })
        return _obj
