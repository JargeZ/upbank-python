...
class UpdateTransactionTagsRequest(BaseModel):
    ...
    """ # noqa: E501
    data: List[TagInputResourceIdentifier] = Field(description="The tags to add to or remove from the transaction. ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [TagInputResourceIdentifier.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
