...
class ListWebhooksResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[WebhookResource] = Field(description="The list of webhooks returned in this response. ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [WebhookResource.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
