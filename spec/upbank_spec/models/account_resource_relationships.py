...
class AccountResourceRelationships(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "transactions": AccountResourceRelationshipsTransactions.from_dict(obj.get("transactions")) if obj.get("transactions") is not None else None
        })
        return _obj
