...
class ListWebhookDeliveryLogsResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[WebhookDeliveryLogResource] = Field(description="The list of delivery logs returned in this response. ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [WebhookDeliveryLogResource.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
