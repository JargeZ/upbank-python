...
class TransactionResourceRelationshipsCategory(BaseModel):
    """
    TransactionResourceRelationshipsCategory
    """ # noqa: E501
    data: Optional[CategoryResourceRelationshipsParentData]
    links: Optional[TransactionResourceRelationshipsCategoryLinks] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CategoryResourceRelationshipsParentData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "links": TransactionResourceRelationshipsCategoryLinks.from_dict(obj.get("links")) if obj.get("links") is not None else None
        })
        return _obj
