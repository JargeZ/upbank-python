...
class WebhookDeliveryLogResource(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type of this resource: `webhook-delivery-logs`")
    id: StrictStr = Field(description="The unique identifier for this log entry. ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": WebhookDeliveryLogResourceAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": WebhookDeliveryLogResourceRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
